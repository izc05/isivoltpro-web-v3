...
export const v3AdminPreview: V3AdminPreview = {
  ...
  entries: [
    ...
    { id: 'content-resources-library', route: '/recursos/', section: 'Biblioteca práctica', title: 'Problemas cotidianos. Respuestas aplicables.', summary: 'Guías para ordenar mantenimiento antes de digitalizar el proceso.', mediaIds: ['media-home-dashboard'], status: 'published', updatedAt: '2026-08-24' },
  ...
  social: [
    ...
    { id: 'social-resources-guide', contentEntryId: 'content-resources-library', channels: ['facebook', 'linkedin'], mode: 'manual', status: 'approved', caption: 'Antes de digitalizar mantenimiento, ordena el proceso. Ocho guías prácticas para empezar.', mediaIds: ['media-home-dashboard'], approvedBy: 'Admin web', approvedAt: '2026-08-24T16:30:00+02:00' },
