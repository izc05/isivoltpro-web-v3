...
export const v3AdminPreview: V3AdminPreview = {
  media: [
    ...
    {
      id: 'media-hvac-equipment',
      title: 'Equipo HVAC UTA-02',
      alt: 'Ilustración conceptual de una unidad HVAC industrial identificada como UTA-02.',
      kind: 'illustration',
      source: 'generated',
      file: '/media/equipo-hvac-isivoltpro.svg',
      tags: ['home', 'producto', 'activos', 'climatizacion'],
      published: true,
    },
    {
      ...
      tags: ['home', 'producto', 'empresa', 'sectores', 'app'],
      published: true,
    },
    {
      ...
      tags: ['home', 'sectores', 'autonomos', 'equipos', 'multisede'],
      published: true,
    },
    {
      id: 'media-sector-scenes',
      title: 'Escenas diferenciadas por sector',
      alt: 'Seis escenas conceptuales para autónomos, mantenedoras, instalaciones propias, climatización y frío, electricidad y multisede.',
      kind: 'illustration',
      source: 'generated',
      file: '/media/sectores-escenas.svg',
      tags: ['sectores', 'autonomos', 'mantenedoras', 'climatizacion', 'electricidad', 'multisede'],
      published: true,
    },
    {
      id: 'media-plans-growth',
      title: 'Crecimiento por etapas',
      alt: 'Tres etapas conceptuales de crecimiento en IsiVoltPro: Autónomo, Equipo y Empresa, conectadas sobre una misma base de trabajo.',
      kind: 'illustration',
      source: 'generated',
      file: '/media/planes-crecimiento.svg',
  ...
  entries: [
    {
      ...
      mediaIds: ['media-home-dashboard', 'media-hvac-equipment'],
      status: 'published',
    ...
    {
      id: 'content-home-operation',
      route: '/',
      section: 'Para quién',
      title: 'La misma base, cuatro formas de trabajar',
      summary: 'Reutilización en Home de la composición visual de escenarios operativos, con entrada directa a la experiencia interactiva.',
    ...
    },
    {
      ...
      mediaIds: ['media-sector-operation', 'media-sector-scenes'],
      status: 'published',
      updatedAt: '2026-08-24',
    },
    {
      id: 'content-plans-growth',
      route: '/precios/',
      section: 'Estructura comercial prevista',
      title: 'Tres niveles. Una misma base.',
      summary: 'Visual conceptual de crecimiento progresivo sin publicar precios, límites ni condiciones ficticias.',
      mediaIds: ['media-plans-growth'],
      status: 'published',
      updatedAt: '2026-08-24',
    },
    {
      id: 'content-company-field-work',
      route: '/empresa/',
      section: 'Trabajo de campo',
      title: 'Del equipo físico al histórico útil',
      summary: 'Historia visual sobre el uso de IsiVoltPro desde el lugar donde ocurre el trabajo.',
      mediaIds: ['media-field-mobile'],
      status: 'published',
      updatedAt: '2026-08-24',
    },
  ...
  revisions: [
    {
      id: 'revision-home-hero-v4',
      contentEntryId: 'content-home-hero',
      version: 4,
      actor: 'Admin web',
      action: 'media_changed',
      summary: 'Se sustituyó la miniatura abstracta del activo por una ilustración propia de la UTA-02.',
      createdAt: '2026-08-24T12:51:00+02:00',
      restorable: true,
    },
    {
    ...
    {
      id: 'revision-home-operation-v1',
      contentEntryId: 'content-home-operation',
      version: 1,
      actor: 'Admin web',
      action: 'published',
      summary: 'Se reutilizó el visual de escenarios operativos en Home sin duplicar el recurso multimedia.',
      createdAt: '2026-08-24T09:04:00+02:00',
      restorable: false,
    },
    {
      id: 'revision-sectors-operation-v2',
      contentEntryId: 'content-sectors-operation',
      version: 2,
      actor: 'Admin web',
      action: 'media_changed',
      summary: 'Se añadieron seis escenas específicas para diferenciar visualmente cada perfil de Sectores.',
      createdAt: '2026-08-24T12:50:00+02:00',
      restorable: true,
    },
    {
    ...
    {
      id: 'revision-plans-growth-v1',
      contentEntryId: 'content-plans-growth',
      version: 1,
      actor: 'Admin web',
      action: 'published',
      summary: 'Se añadió un visual propio para explicar el crecimiento de planes sin inventar precios.',
      createdAt: '2026-08-24T09:08:00+02:00',
      restorable: false,
    },
    {
      id: 'revision-company-field-work-v1',
      contentEntryId: 'content-company-field-work',
      version: 1,
      actor: 'Admin web',
      action: 'published',
      summary: 'Se reutilizó el visual móvil en Empresa y se marcó el recurso como publicado.',
      createdAt: '2026-08-24T09:12:00+02:00',
      restorable: false,
    },
  ],
  social: [
