...
export const v3AdminPreview: V3AdminPreview = {
  media: [
    ...
    { id: 'media-field-mobile', title: 'Trabajo técnico desde tablet', alt: 'Técnico consultando un activo y su orden de trabajo desde una tablet.', kind: 'photo', source: 'generated', file: '/media/v4/field-technician-tablet-v2.webp', tags: ['home', 'producto', 'empresa', 'sectores', 'app'], published: true },
